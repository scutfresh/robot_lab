...
class UnitreeGo2ArmRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.observations.policy.base_ang_vel.scale = 0.5
        ...
        # self.commands.base_velocity.ranges.ang_vel_z = (-1.0, 1.0)
                ...
                # ------------------------------Freeze Arm & Extra Joints------------------------------
        # 惩罚手臂关节 (joint1-6) 和 left/right_joint 的运动
        # 惩罚 arm 和额外 joint 偏离 0 位置
        # 惩罚 arm 和额外 joint 的速度
